...
function getdata()
{
    ...
    var ref = database.ref().child("caption");
    var a = 0;
    var n = 0;
    ref.once("value").then(function(snapshot){
      snapshot.forEach(function(snap){
        data[n] = snap.val().caption;
      ...
      var area = document.getElementById('try');
        ...
        for(var j = 0; j < data.length; j++){
             area.innerHTML += "<textarea class = 'js-captionArea' readonly='readonly' style='font-family: 'Palatino''></textarea><button class = 'js-CopyBtn'>Copy</button>&emsp; &emsp; &emsp;";
             //console.log("thakkar")
        }
