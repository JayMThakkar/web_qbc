...
<!-- Pricing
  ...
  <div id="pricing" class="pricing-background">
    ...
    <div class="pricing-table row">
        <div class="col-sm-4">
                        	<a href="log.php"><img src="assets/images/cap.png" style="border-radius: 18px; height: 300px; width: 300px; box-shadow: 5px 8px 40px; rgba(99, 117, 138, 0.3); "></a>
        ...
        <div class="col-sm-4">
            <div class="mid-plan">
            	<a href="log.php"><img src="assets/images/Quote.png" style="border-radius: 18px; height: 300px; width: 300px; box-shadow: 5px 8px 40px; rgba(99, 117, 138, 0.3); "></a>
        ...
        <div class="col-sm-4">
            <div class="mid-plan">
                <a href="log.php"><img src="assets/images/Bio.png" style="border-radius: 18px; height: 300px; width: 300px; box-shadow: 5px 8px 40px; rgba(99, 117, 138, 0.3); "></a>
            </div><!--pro-plan--->
        </div><!--col-->
...
<div class="white-section row">
    ...
    <div id= "about" class="about_title">
        <h1 class="title_about" style="text-align: center; padding-top: 15px;">About Us</h1>
    </div>

    <div class="imac col-sm-6">
        <!--img class="imac-screen img-responsive" src="assets/images/imac.png"-->
        <video class="imac-screen img-responsive" controls autoplay width="500" height="400" style="margin-left: 110px; margin-top: 10px;">
            <source src="assets/images/qbc.mp4" type="video/mp4">
          </video>
    </div>
    <!--imac-->
    ...
    <div class="col-sm-6">
        ...
        <div class="white-section-text">
            ...
            <h2 class="imac-section-header light" style="margin-top: -10;">Quote-Bio-Caption</h2>

            <div class="imac-section-desc">

            <span>  The need of the user is been fulfilled by this simple and handy mobile app called as QBC: 
                Quotes-Bio's-Caption.It is a collection of these 3 components,the user need not have run for 
                the different application to get cool and attractive contents for their posts and photos.</span>
            </div>
        </div>
    </div>
